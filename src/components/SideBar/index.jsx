...
const Sidebar = () => {
  ...
  return (
            <aside className="Sidebar !p-5">
                ...
                <div className="box">
                    <h3 className ='w-full !mb-3 text-[16px] font-[600] flex items-center !pr-5'>Avilability
                    ...
                    <Collapse isOpened={isOpenAvailabilityFilter}>
                     <div className="scroll !px-4 relative -left-[13px]">
                    <FormControlLabel control={<Checkbox size="small"/>} label="Avilable (17)" className="w-full"/>
                ...
                <div className="box !mt-3">
                    ...
                    <FormControlLabel control={<Checkbox size="small"/>} label="Mediuum (17)" className="w-full"/>
