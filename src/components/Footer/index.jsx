        ...
        <div className="container">
            <div className="flex items-center justify-center !gap-2 !py-8 !pb-8">
                ...
                <div className="col1 flex items-center justify-center flex-col group w-[15%]">
                    ...
                    <p className='text-[12px] font-[400]'>Our First Product Order0</p>
                </div>
            ...
            <div className="footer flex !py-8">
                <div className="part1 w-[25%] border-r border-[rgba(0,0,0,0.1)]">
                    ...
                    <Link to ="mailto:someone@example.com" className='link text-[13px]'>sales@yourcompany.com</Link>
                <span className='text-[22px] font-[600] block w-full !mt-3 mb-5 text-[#ff5252]'>(+91) 9876-543-210</span>
                ...
                <div className="part2 w-[40%] flex !pl-8">
                    ...
                    <div className="part2_col2 w-[50%]">
                        ...
                        <ul className="list">
                            ...
                            <li className='list-none text-[14px] w-full mb-2'><Link to="/" className='link'>Tems And Conditions of Use</Link></li>
...
<div className="bottomStrip border-t border-[rgba(0,0,0,0.1)] !py-3 bg-white">
    <div className="container flex items-center justify-between">
        <ul className='flex items-center gap-2'>
            ...
            <li className='list-none '><Link to ="/" target='_blank ' className='w-[35px] h-[35px] rounded-full border border-[rgba(0,0,0,0.1)] flex items-center justify-center group hover:bg-[#ff5252] transition-all'>
            <FiYoutube className='text-[20px]  group-hover:text-white'/>
            </Link></li>
        ...
        <p className='text-[13px] text-center !mb-0'>
            ...
            <Drawer open={context.openCartPanel} onClose={context.toggleCartPanel(false)} anchor={"right"} className="cartPanel">
                ...
                {
                    context.cartData.length !== 0 ?  <CartPanel /> :<>
                    <div className="flex items-center justify-center flex-col !pl-5  gap-3"></div>
                
                    <h3 className=' !pl-5 text-[18px] font-[500]'>Your Cart is Empty!</h3></>
